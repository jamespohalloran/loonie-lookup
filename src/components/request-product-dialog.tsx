        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white p-6 shadow-lg">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-4 space-y-4">
            ...
            <div>
              ...
              />
              {errors.productRequest && (
                <p className="mt-1 text-sm text-red-600">{errors.productRequest.message}</p>
              )}
            </div>
            ...
            <div className="mt-6 flex justify-end space-x-3">
              ...
              <button
                type="submit"
                className="rounded-md bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-500 disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={isSubmitting}
              >
